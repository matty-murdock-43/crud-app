...
INSERT INTO Worker(id, email, f_name, l_name) VALUES (default, 'beans@test.com', 'Beans', 'Naam to suna hoga');
...
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, task_status) VALUES (default, uuid(), 'Task 2', '2030-02-10', 'Task 2 Description', 1, 0);
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, task_status) VALUES (default, uuid(), 'Task 3', '2030-03-16', 'Task 3 Description', 1, 0);
